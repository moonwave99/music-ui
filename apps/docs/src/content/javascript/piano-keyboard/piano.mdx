...
If you need more control over the piano rendering, you can use the `Piano` class.
...
<Piano notes="C3 C4, E4 G4 C5" octaves={3} showOctaves />
...
const piano = new Piano();
piano.render();
piano.setNotes("F3 Ab3 C4 Eb4", "1 3 5 7");
```
...
const piano = new Piano();
piano.render();
piano.setNotes("F3 Ab3 C4 Eb4", "_ 3 _ 7");
```

<Piano notes="F3 Ab3 C4 Eb4" noteLabels="_ 3 _ 7" />
