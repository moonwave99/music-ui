...
<ABCScore showTempo={false} abcOptions={{ foregroundColor: "orange" }}>
  CDEF GABc|
</ABCScore>
...
You can pass a new [position](/api/types/_music-ui_core.TransportPosition.html) to `ABCScore.highlightBar` to highlight the corresponding bar:
