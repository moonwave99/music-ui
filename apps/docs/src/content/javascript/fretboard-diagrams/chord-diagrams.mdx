...
You can pass a custom selector or collection of elements. In this example we'll select all `.chord` elements:
...
| `data-show-note-names`      | `boolean` | Shows the note names.                          |
