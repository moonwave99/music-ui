...
The `<PianoWithPlayer>` React component adds playback functionality to the [`<Piano>` component](/react/piano-keyboard/piano).
...
In addition to the [`Piano` component props](/react/piano-keyboard/piano#component-props), the component accepts the following props:
